...
# Install 'arch-update' using AUR Helper 
...
# 2nd step 
echo "You will be presented with a selection of packages. It is entirely up to you wether you choose to download them or not"

echo "Would you like to install Timeshift (and xorg-xhost)?"
sudo pacman -Sy timeshift xorg-xhost
